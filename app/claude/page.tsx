                        ...
                        {loadingScripts ? (
                            ...
                            <>
                                ...
                                <div className="text-xs text-zinc-500 dark:text-zinc-400 mb-3">
                                    {startIndex + 1}-{Math.min(endIndex, claudeScripts.length)} of {claudeScripts.length}
                                </div>
                                ...
                                <div className="flex flex-col gap-2">
                                    {paginatedScripts.map((script) => (
                                        <div
                                            key={script.id}
                                            className={`p-3 rounded border border-solid transition-colors ${script.isActive
